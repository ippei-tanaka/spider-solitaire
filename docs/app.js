...
var Deferred = /** @class */ (function () {
    ...
    Object.defineProperty(Deferred.prototype, "onStartCallback", {
    ...
    Object.defineProperty(Deferred.prototype, "onEndCallback", {
        set: function (callback) {
    ...
    Object.defineProperty(Deferred.prototype, "isIntact", {
        get: function () {
    ...
    Object.defineProperty(Deferred.prototype, "isProcessing", {
        get: function () {
...
var PromiseQueue = /** @class */ (function () {
    ...
    PromiseQueue.prototype.add = function (createPromise) {
        var _this = this;
        var deferred = new Deferred({ createPromise: createPromise });
        deferred.onStartCallback = function () {
            _this._emitter.emit("PROMISE_START", {});
        };
        deferred.onEndCallback = function (value) {
            _this._emitter.emit("PROMISE_END", { value: value });
            _this._currentIndex = _this._currentIndex + 1;
            _this._process();
        };
        this._deferedQueue = __spreadArrays(this._deferedQueue, [
            deferred
        ]);
        this._process();
    };
    PromiseQueue.prototype._process = function () {
        ...
        if (this._currentIndex < this._deferedQueue.length) {
            var deferred = this._deferedQueue[this._currentIndex];
    ...
    PromiseQueue.prototype.cancel = function () {
        var _this = this;
        ...
        if (!hasStarted || !deferred || !deferred.isProcessing) {
            ...
            deferred.onEndCallback = function (value) {
                _this._emitter.emit("PROMISE_END", { value: value });
                _this._emitter.emit("QUEUE_CANCEL", { wasProcessing: true });
            };
        }
    };
    PromiseQueue.prototype.onQueueStart = function (callback) {
        this._emitter.on('QUEUE_START', callback);
    };
    PromiseQueue.prototype.onQueueEnd = function (callback) {
        this._emitter.on('QUEUE_END', callback);
    };
    PromiseQueue.prototype.onQueueCancel = function (callback) {
        this._emitter.on('QUEUE_CANCEL', callback);
    };
    PromiseQueue.prototype.onPromiseStart = function (callback) {
        this._emitter.on('PROMISE_START', callback);
    };
    PromiseQueue.prototype.onPromiseEnd = function (callback) {
